      ...
      <div className="text-center p-6">
        ...
        <div className="flex flex-col gap-[20px]">
          <div className="flex justify-center items-between gap-[20px]">
            <div className="p-1 bg-gray-500 bg-opacity-30 rounded-lg m-2 border-2 border-gray shadow-[5px_5px_13px_0_rgba(0,0,0,0.3)]">
            ...
            <div className="p-1 bg-gray-500 bg-opacity-30 rounded-lg m-1 border-2 border-gray shadow-[5px_5px_13px_0_rgba(0,0,0,0.3)]">
