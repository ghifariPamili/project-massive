            ...
            <div className="">
              <div className="flex flex-col justify-center items-center mr-[10px] mt-[20px] gap-[10px] text-white">
                <div className="w-full border-b-[2px] h-[30px]">
                  <div className="flex justify-start items-center gap-[13px] w-full mx-[10px]">
          ...
          <div className="h-[60px] flex justify-start items-center">
            <div className="ml-[10px]">
              <button
                ...
                className="size-full bg-white border-2 border-colorPrimer flex flex-row gap-[10px] justify-center items-center p-2 rounded-[20px]"
              >
                <div className="font-semibold text-colorPrimer text-[14px]">Driver</div>
                <div className="circle w-5 h-5 rounded-full bg-colorPrimer"></div>
