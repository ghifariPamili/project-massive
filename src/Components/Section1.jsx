      ...
      <div className='rightDiv w-[50%] h-[100%] flex flex-col items-center justify-start'>
        <div className='h-[85%] w-[100%] px-[150px] flex flex-col items-start justify-center gap-[70px]'>
          <div className='flex flex-col gap-[14px]'>
            ...
            <p className='text-blue-950 text-[24px] pr-[160px] leading-tight'>Kami akan membantumu untuk tetap cozy di tempatmu,<br />
        ...
        <div className='flex flex-col gap-[22px] justify-start items-start h-[15%] w-full px-[150px]'>
